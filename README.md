# 🏆 Winners Shop — Game Top-Up & Bot Ecosystem
...
- 📱 **Telegram Bot UI**: Styled inline buttons with custom animations and deep-link authorization.
- 🌐 **Modern Web Store & Admin Panel**: Fully responsive dashboard with real-time statistics.

## 🛠️ Tech Stack
- **Runtime**: Node.js v22+ (TypeScript)
- **Database**: SQLite (Node.js native `DatabaseSync` in WAL mode)
- **Telegram Framework**: grammY + grammY Runner
- **Web Server**: Express.js + Nginx Reverse Proxy
- **Process Manager**: PM2

## 📄 License
Private & Proprietary — Winners Shop.
